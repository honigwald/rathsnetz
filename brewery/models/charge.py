...
class Charge(models.Model):
    ...
    def run_hop_calculator(self):
        for step in self.recipe.hop_steps():
            step.calculate_hopping(self)
    ...
    # step = models.ForeignKey(RecipeBrewStep, on_delete=models.DO_NOTHING, blank=True, null=True)
